...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //Or you can just call [SNSFacebook application:application didFinishLaunchingWithOptions:launchOptions] without return
         ...
         annotation:(id)annotation
{
    ...
    {
        return [SNSFacebook application:application
                                openURL:url
                      sourceApplication:sourceApplication
                             annotation:annotation];
    }
    else if ([stringUrl hasPrefix:@"tw-"])
    {
        [SNSTwitter openURL:url];
    }
